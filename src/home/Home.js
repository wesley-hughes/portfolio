export const Home = () => {
  return (
    <>
      ...
      <a href="/" class="flex flex-col mx-auto my-[150px] items-center justify-around bg-white w-[75%] md:flex-row h-[450px] border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    <div class="flex flex-col object-cover justify-between p-4 leading-normal">
